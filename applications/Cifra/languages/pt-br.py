...
'Desculpa, por enquanto, so Cifra Club': 'Desculpa, por enquanto, so Cifra Club',
'Desculpa, por enquanto, so cifraclub': 'Desculpa, por enquanto, so cifraclub',
'design': 'design',
'DISK': 'DISK',
...
'Sorry, only music form cifraclub!': 'Sorry, only music form cifraclub!',
'state': 'estado',
